...
public class GeometriesTest {
    ...
    void testFindIntersections()
    {
        ...
        Sphere sp = new Sphere( 1,new Point(1, 0, 0));
        ...
        Geometries gr2 = new Geometries(tr, pl, new Sphere( 3,new Point(0, 0, 3)));
        ...
        Geometries gr3 = new Geometries(tr, new Plane(new Point(0, 0, 7), new Vector(0, 0, 1)), new Sphere( 2,new Point(0, 0, 3)) );
