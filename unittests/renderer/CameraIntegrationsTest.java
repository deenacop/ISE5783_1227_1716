...
public class CameraIntegrationsTest {
    ...
    private void assertCountIntersections(int expected, Camera cam, Intersectable geo) {
        ...
        System.out.format("there is %d points:%n", counter);
        if (points != null) {
            for (var item : points) {
    ...
    public void cameraRaySphereIntegration() {
        ...
        assertCountIntersections(2, cam1, new Sphere(1, new Point(0, 0, -3)));

        // TC02: Big Sphere 18 points
        assertCountIntersections(18, cam2, new Sphere(2.5, new Point(0, 0, -2.5)));

        // TC03: Medium Sphere 10 points
        assertCountIntersections(10, cam2, new Sphere(2, new Point(0, 0, -2)));

        // TC04: Inside Sphere 9 points
        assertCountIntersections(9, cam2, new Sphere(4, new Point(0, 0, -1)));

        // TC05: Beyond Sphere 0 points
        assertCountIntersections(0, cam1, new Sphere(0.5, new Point(0, 0, 1)));
    }
    ...
    public void cameraRayPlaneIntegration() {
        ...
        assertCountIntersections(9, cam, new Plane(new Point(0, 0, -5), new Vector(0, 0, 1)));

        // TC02: Plane with small angle 9 points
        assertCountIntersections(9, cam, new Plane(new Point(0, 0, -5), new Vector(0, 1, 2)));

        // TC03: Plane parallel to lower rays 6 points
        assertCountIntersections(6, cam, new Plane(new Point(0, 0, -5), new Vector(0, 1, 1)));
